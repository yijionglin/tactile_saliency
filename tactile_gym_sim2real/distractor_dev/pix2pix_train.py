...
def main(opt, augmentation_params, weights, task_dirs, data_dirs):
    ...
    training_sim_data_dirs = os.path.join(home_dirs,'data', task_dirs, 'target',image_size_str, 'csv_train/images') 
    validation_sim_data_dirs = os.path.join(home_dirs,'data', task_dirs, 'target',image_size_str, 'csv_val/images') 
