...
# sim data dir
# data_dir = '/home/alex/Documents/pybullet_sims/pybullet_sims/rl_algos/stable_baselines/saved_models/edge_follow/ppo/keep/128_rand_vel/eval_data'
# data_dir = '/home/alex/Documents/pybullet_sims/pybullet_sims/rl_algos/stable_baselines/saved_models/edge_follow/ppo/obs_space_test/test_1/oracle/eval_data'
# data_dir = '/home/alex/Documents/pybullet_sims/pybullet_sims/rl_algos/stable_baselines/saved_models/edge_follow/ppo/keep/128_rand_vel_actlim_0.25/eval_data'
# data_dir = '/home/alex/Documents/pybullet_sims/pybullet_sims/rl_algos/stable_baselines/saved_models/edge_follow/ppo/s2/eval_data'
...
real_sim_data_dirs = ['data', 'sim_data']
colours_dict = {
    'data': 'red',
    'sim_data': 'blue'
}
...
for real_sim in real_sim_data_dirs:

    df = pd.read_csv(os.path.join('collected_data', real_sim, data_dir, 'evaluation_movement_data.csv'),
    ...
    # plot figure
    scat_step_size = 1
    ax.scatter(px[::scat_step_size], py[::scat_step_size], color=colours_dict[real_sim], label=label_dict[real_sim], marker='.', alpha=0.35)
...
fig.savefig(os.path.join('collected_data', 'sim_data', data_dir, 'edge_scatter_comparison.png'), dpi=320, pad_inches=0.01, bbox_inches='tight')
plt.show()
