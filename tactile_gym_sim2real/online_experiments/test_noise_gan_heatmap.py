...
while True:
    ...
    # con_overlay_images_with_sal = np.concatenate([overlay_raw_image_w_sal, overlay_depth_image_with_sal], axis=1)
    denoise_img = np.concatenate([raw_real_image, overlay_raw_image_w_dep,overlay_raw_image_w_sal], axis=1)
